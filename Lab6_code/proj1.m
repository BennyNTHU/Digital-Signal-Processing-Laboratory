...
% imwrite(high_frequencies + 0.5, 'high_frequencies6.jpg', 'quality', 95);
imwrite(hybrid_image, 'hybrid_cutoff_3.jpg', 'quality', 95);
% imwrite(vis, 'hybrid_image_scales6.jpg', 'quality', 95);
